...
my_file = 'c:/Users/bisuser/Documents/lime/free_bike_status.json'
my_lime_data = ''
my_lime_locs = []
...
my_debug_file = 'c:/Users/bisuser/Documents/lime/errors'
my_debug_fh = ''
try:
...
my_lime_df = pandas.DataFrame(my_lime_bikes)
my_debug_fh.write(my_lime_df)

try:
    my_lime_geom = [Point(lon, lat) for lon, lat in zip(my_lime_df['lon'], my_lime_df['lat'])]
except:
    print('error: ', my_lime_df['lon'], my_lime_df['lat'])
    my_lime_geom = [Point(33.603921, -118.234092)]
